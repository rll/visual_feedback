...
void help(){  
    printf("Birds eye view\n\n"  
            "  birdseye board_w board_h intrinsics_mat.xml distortion_mat.xml checker_image init_height\n\n"  
...
int main(int argc, char* argv[]) {  
   ...
   float init_height = atof(argv[6]);  
    ...
    cvSaveImage("birdseye.png",birds_image);
    return 0;
...
//</stdlib.h></stdio.h></highgui.h></cv.h>  
